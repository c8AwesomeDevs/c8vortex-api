...
class T3SVGService extends SVGHelpers
{
    // private $regions = [
    ...
    public function gen_t3($data)
    {
        ...
        $polygons = "<polygon points='219.4,42.36990700363636 215.74333333333334,48.353355256363685 223.05666666666667,48.353355256363685' fill='pink'/><polygon points='215.74333333333334,48.353355256363685 212.08666666666667,54.336803509090885 308.98833333333334,212.89818197145456 316.3016666666667,200.93128547636366 223.05666666666667,48.353355256363685' fill='purple'/><polygon points='316.3016666666667,200.93128547636366 308.98833333333334,212.89818197145456 360.1816666666667,296.6664573818182 367.495,284.6995609109091' fill='LimeGreen'/><polygon points='367.495,284.6995609109091 402.23333333333335,341.54231922545455 332.75666666666666,341.54231922545455' fill='HotPink'/><polygon points='212.08666666666667,54.336803509090885 360.1816666666667,296.6664573818182 332.75666666666666,341.54231922545455 296.19000000000005,341.54231922545455 239.51166666666666,248.798871436 268.76500000000004,200.93128547636366 195.6316666666667,81.26232059454546' fill='blue'/><polygon points='195.6316666666667,81.26232059454546 232.19833333333335,141.0968030527273 109.7,341.54231922545455 36.56666666666666,341.54231922545455' fill='SkyBlue'/><polygon points='296.19000000000005,341.54231922545455 239.51166666666666,248.798871436 268.76500000000004,200.93128547636366 232.19833333333335,141.0968030527273 109.7,341.54231922545455' fill='#679A00'/>";
        ...
        foreach ($clean as $key => $value) {
            ...
            $circles .= "<circle r='{$this->circleSize($key)}' cx='{$x}' cy='{$y}' id='plot-t3-{$key}' style='fill: {$this->circleColor($key,$clean_length)}; cursor: pointer;'/>";
            ...
            $tooltipHTML .= "<div id='plot-t3-{$key}-pup' style='padding: 5px; font-size: 10px;background: #fff; position: absolute; display: none; visibility: hidden; font-family: calibri; border: 1px solid #cccccc'><table width='100%' class='basic-table' style='font-size:12px;'>";
            ...
            $tooltipHTML .= "<tr><td style='font-weight:bold;'>Fault </td><td>{$value['t3']}</td></tr>";
            ...
            array_push($popup_mapping, ["plot-t3-{$key}", "plot-t3-{$key}-pup"]);
        }
