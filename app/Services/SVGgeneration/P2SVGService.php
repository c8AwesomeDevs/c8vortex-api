...
class P2SVGService extends SVGHelpers
{
    // private $regions = [
    ...
    //     if ($this->pointInPolygon($point, $this->regions['C'])) {
    //         return "C";
    //     } elseif ($this->pointInPolygon($point, $this->regions['T3-H'])) {
    //         return "T3-H";
    ...
    public function gen_p2($data)
    {
        ...
        $polygons = "<polygon points='123.33333333333333,468 193.33333333333334,312 242.66666666666666,279.50000000000006 283.3333333333333,468' fill='hotpink' stroke-width='2'/><polygon points='426.6666666666667,454.99999999999994 424,468 283.3333333333333,468 243.33333333333334,279.50000000000006 266.66666666666663,279.50000000000006' fill='blue' stroke-width='2'/><polygon points='293.3333333333333,156 480,299 426.6666666666667,454.99999999999994 266.66666666666663,279.50000000000006 266.66666666666663,260' fill='LimeGreen' stroke-width='2'/><polygon points='266.66666666666663,0 520,182.00000000000003 480,299 293.3333333333333,156 266.66666666666663,260' fill='#679A00' stroke-width='2'/><polygon points='266.66666666666663,45.49999999999997 266.66666666666663,100.75000000000001 260,100.75000000000001 260,45.49999999999997' fill='pink' stroke-width='2'/><polygon points='33.33333333333333,240.5 13.333333333333334,182.00000000000003 266.66666666666663,0 266.66666666666663,45.49999999999997 260,45.49999999999997 260,100.75000000000001 266.66666666666663,100.75000000000001 266.66666666666663,250.25' fill='purple' stroke-width='2'/><polygon points='123.33333333333333,468 109.33333333333331,468 33.33333333333333,240.5 266.66666666666663,250.25 266.66666666666663,279.50000000000006 243.33333333333334,279.50000000000006 193.33333333333334,312' fill='SkyBlue' stroke-width='2'/>";
        ...
        foreach ($clean as $key => $value) {
            ...
            $circles .= "<circle r='{$this->circleSize($key)}' cx='{$x}' cy='{$y}' id='plot-p2-{$key}' style='fill: {$this->circleColor($key,$clean_length)}; cursor: pointer;'/>";
            ...
            $tooltipHTML .= "<div id='plot-p2-{$key}-pup' style='padding: 5px; font-size: 10px;background: #fff; position: absolute; display: none; visibility: hidden; font-family: calibri; border: 1px solid #cccccc'><table width='100%' class='basic-table' style='font-size:12px;'>";
            ...
            $tooltipHTML .= "<tr><td style='font-weight:bold;'>Fault </td><td>{$value['p2']}</td></tr>";
            ...
            array_push($popup_mapping, ["plot-p2-{$key}", "plot-p2-{$key}-pup"]);
        }
