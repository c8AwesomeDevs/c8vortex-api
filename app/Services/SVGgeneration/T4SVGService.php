...
class T4SVGService extends SVGHelpers
{
    // private $regions = [
    ...
    public function gen_t4($data)
    {
        ...
        $polygons = "<polygon points='223.05666666666667,48.353355256363685 221.22833333333332,51.345079365454524 244.99666666666667,90.23749295636362 246.82500000000002,87.24576884727274' fill='pink' stroke-width='2'/><polygon points='219.4,42.36990700363636 135.29666666666668,179.98921664363638 221.22833333333332,314.61680214 276.0783333333333,314.61680214 265.10833333333335,296.6664573818182 287.04833333333335,296.6664573818182 241.34000000000003,221.87335433672726 285.22,150.07197541454545 246.82500000000002,87.24576884727274 244.99666666666667,90.23749295636362 221.22833333333332,51.345079365454524 223.05666666666667,48.353355256363685' fill='purple' stroke-width='2'/><polygon points='285.22,150.07197541454545 241.34000000000003,221.87335433672726 287.04833333333335,296.6664573818182 265.10833333333335,296.6664573818182 292.5333333333333,341.54231922545455 402.23333333333335,341.54231922545455' fill='LimeGreen' stroke-width='2'/><polygon points='276.0783333333333,314.61680214 53.02166666666667,314.61680214 36.56666666666666,341.54231922545455 292.5333333333333,341.54231922545455' fill='HotPink' stroke-width='2'/><polygon points='135.29666666666668,179.98921664363638 53.02166666666667,314.61680214 221.22833333333332,314.61680214' fill='blue' stroke-width='2'/>";
        ...
        foreach ($clean as $key => $value) {
            ...
            $circles .= "<circle r='{$this->circleSize($key)}' cx='{$x}' cy='{$y}' id='plot-t4-{$key}' style='fill: {$this->circleColor($key,$clean_length)}; cursor: pointer;'/>";
            ...
            $tooltipHTML .= "<div id='plot-t4-{$key}-pup' style='padding: 5px; font-size: 10px;background: #fff; position: absolute; display: none; visibility: hidden; font-family: calibri; border: 1px solid #cccccc'><table width='100%' class='basic-table' style='font-size:12px;'>";
            ...
            $tooltipHTML .= "<tr><td style='font-weight:bold;'>Fault </td><td>{$value['t4']}</td></tr>";
            ...
            array_push($popup_mapping, ["plot-t4-{$key}", "plot-t4-{$key}-pup"]);
        }
