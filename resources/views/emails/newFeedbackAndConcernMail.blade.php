                                                                            ...
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                                    ...
                                                                                    <h1 class="h3"
                                                                                        ...
                                                                                        align="left">New Feedback and
                                                                                        Support concern was raised by a
                                                                                        user</h1>
                                                                                        ...
                                                                                        <table class="table"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="border fw-700"
                                                                                                        style="line-height: 24px; font-size: 16px; font-weight: 700 !important; margin: 0; padding: 12px; border: 1px solid #e2e8f0;"
                                                                                                        align="left"
                                                                                                        valign="top">
                                                                                                        {{ $datetime }}
                                                                                                    </td>
                                                                                    ...
                                                                                    <div class="text-xs"
                                                                                        ...
                                                                                        <table class="pt-6"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="line-height: 24px; font-size: 16px; padding-top: 24px; margin: 0;"
                                                                                                        align="left">
                                                                                                        <div
                                                                                                            class="">
                                                                                                            <img width="100"
