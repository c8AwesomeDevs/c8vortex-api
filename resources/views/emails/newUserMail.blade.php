{{-- this email template was generated using https://app.bootstrapemail.com/editor --}}
    ...
    <style type="text/css">
        ...
        * {
        ...
        @media screen and (max-width: 600px) {
            ...
            .gap-2.row>table>tbody>tr>td,
            .gap-x-2.row>table>tbody>tr>td {
            ...
            .gap-2.row>table>tbody>tr>td,
            .gap-y-2.row>table>tbody>tr>td {
                padding-bottom: 8px !important
            }

            table.gap-2.stack-x>tbody>tr>td {
                padding-right: 8px !important
            }

            table.gap-2.stack-y>tbody>tr>td {
                padding-bottom: 8px !important
            }
                                                                                ...
                                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                                    ...
                                                                                                    <div class="">
                                                                                                        <img width="250"
                                                                                                            src="https://calibr8.systems/wp-content/uploads/2023/02/Calibr8_FULL_LOGO_TRANSPARENT.png"
                                                                                    ...
                                                                                    <div class="space-y-3">
                                                                                        ...
                                                                                        <p class="text-gray-700"
                                                                                            ...
                                                                                            align="left">Your account
                                                                                            registration has been
                                                                                            received and is now in the
                                                                                        ...
                                                                                        <h5 class="text-gray-700"
                                                                                            style="color: #4a5568; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;"
                                                                                            align="left">
                                                                                            <i>What is C8 Vortex?</i>
                                                                                        </h5>
                                                                                        <table class="s-3 w-full"
                                                                                            role="presentation"
                                                                                            border="0"
                                                                                        ...
                                                                                        <p class="text-gray-700 text-justify"
                                                                                            style="text-indent: 2em; line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"
                                                                                            align="justify">C8 Vortex
                                                                                            is a transmission and
                                                                                            distribution asset
                                                                                            monitoring suite that allows
                                                                                            users to monitor and analyze
                                                                                            critical equipment in real
                                                                                            time using built-in
                                                                                            analytics to maintain high
                                                                                            efficiency, increase
                                                                                            productivity, and reduce
                                                                                            breakdowns. It includes a
                                                                                            monitoring module for
                                                                                            dissolved gas analysis,
                                                                                            along with Duval's
                                                                                            diagnostic suite, which can
                                                                                            provide critical and
                                                                                            accurate insight into your
                                                                                            equipment's health and
                                                                                            empower you to make
                                                                                            maintenance decisions before
                                                                                            any major issues arise! </p>
                                                                                        <table class="s-3 w-full"
                                                                                            role="presentation"
                                                                                            border="0"
                                                                                            cellpadding="0"
                                                                                        ...
                                                                                        <h5 class="text-gray-700"
                                                                                            style="color: #4a5568; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;"
                                                                                            align="left">
                                                                                            <i>Easily monitor your
                                                                                                assets
                                                                                                with real-time data</i>
                                                                                        </h5>
                                                                                        <table class="s-3 w-full"
                                                                                            role="presentation"
                                                                                            border="0"
                                                                                                        ...
                                                                                                        <td class="col-4"
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    <tr>
                                                                                                                        <td class="stack-cell"
                                                                                                                            style="line-height: 24px; font-size: 16px; padding-right: 8px; margin: 0;"
                                                                                                                            align="left"
                                                                                                                            valign="top">
                                                                                                                            <img width="20"
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    <tr>
                                                                                                                        <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;"
                                                                                                                            align="center">
                                                                                                                            <a style="background-color: #c83811; color: white; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; padding: 8px 12px; border: 1px solid transparent;"
                                                                                                                                href=""
                                                                                                                                target="_blank">Learn
                                                                                                                                more</a>
                                                                                                                        </td>
                                                                                    ...
                                                                                    <div class="text-xs"
                                                                                        style="font-size: 12px; line-height: 14.4px;">
                                                                                        <table class="pt-3"
                                                                                            role="presentation"
                                                                                            border="0"
                                                                                            cellpadding="0"
                                                                                        ...
                                                                                        <div class="fw-700"
                                                                                            ...
                                                                                            Calibr8 Systems Inc.</div>
                                                                                        <div>Unit 1606 The Centerpoint
                                                                                            Condominium</div>
                                                                                        <div>Garnet St. corner Dona
                                                                                            Julia Vargas Ave.</div>
                                                                                        <div>Ortigas Center, Pasig City
                                                                                            1600</div>
                                                                                        <a href="https://calibr8.systems/about-us/"
                                                                                            style="color: #0d6efd;">About</a>
                                                                                        <a href="https://calibr8.systems/c8-contact-page/"
                                                                                            style="color: #0d6efd;">Contact</a>
                                                                                        <table class="s-3 w-full"
                                                                                            role="presentation"
                                                                                            border="0"
                                                                                            cellpadding="0"
